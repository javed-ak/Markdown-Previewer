...
\`\`\`
  ...
  return (
    ...
    <div className="bg-zinc-100">
      ...
      <div className="grid grid-col-1 lg:grid-cols-2 gap-2 h-screen">
        <div className="bg-zinc-50 shadow-lg h-screen">
        ...
        <div className="bg-zinc-5 shadow-lg bg-zinc-50 h-screen">
